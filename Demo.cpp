...
int main()
{
    ...
    cout << Algorithms::isContainsCycle(g) << endl;    // Should print: "0->1->0". (my graph is directed, there is one option for cycle, the first option that the algorithm found)
    ...
    {
        cout << e.what() << endl; // Should print: "Invalid graph: The matrix is not square."
    }
}